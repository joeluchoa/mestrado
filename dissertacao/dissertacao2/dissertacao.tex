...
% orifício de 10,7cm de largura x 6,0cm de altura que há na capa 
% fornecida pela SPG.
\thispagestyle{empty}
\begin{center}
    \vspace*{2.3cm}
    \textbf{\Large{Caminhos mínimos com recursos limitados}}\\
    ...
    \vskip 2cm
    \textsc{
    Dissertação apresentada\\[-0.25cm] ao\\[-0.25cm]
    ...
    auxílio financeiro da CAPES}
    
    \vskip 0.5cm
    \normalsize{São Paulo, junho de 2011}
\end{center}
...
\thispagestyle{empty}
    ...
    \begin{itemize}
    \item Profa. Dra. Nome Completo (orientadora) - IME-USP [sem ponto 
    final]
